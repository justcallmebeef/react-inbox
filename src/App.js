...
class App extends Component {
  ...
  async componentDidMount() {
    let result = await fetch("https://collective-api-db.herokuapp.com/api/messages")
  ...
  patch = async (id, command, attribute, value) => {
    ...
    const response = await fetch('https://collective-api-db.herokuapp.com/api/messages', {
      method: 'PATCH',
  ...
  postMessage = () => {
      ...
      fetch('https://collective-api-db.herokuapp.com/api/messages', {
      method: 'POST',
